function [weight]= sLORETA(Lp,data,flags)%eqn(3.83)sLORETA
...
% G is the R in beamformer
% To compute the projection of the vector output onto the direction that
% gives the maximum power output, see Eqn(2.78) in the Book Adaptive Spatial
% Filters for Electromagnetic Brain Imaging
